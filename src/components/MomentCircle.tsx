...
const MomentCircle = ({ moment }: { moment: Moment & {author: User} }) => {
  return (
...
// have to do the moments page 
// it will be a client side modal 
// will uyse react top loading bar to show progress